...
namespace PivotGridCustomization.Module.Win {
    ...
    protected override void RegisterEditorDescriptors(List<DevExpress.ExpressApp.Editors.EditorDescriptor> editorDescriptors) {
            ...
            editorDescriptors.Add(new DetailViewItemDescriptor(new DetailViewItemRegistration(typeof(IModelPivotGridCustomizationItem), typeof(PivotGridCustomizationDetailViewItem), true)));
    }
