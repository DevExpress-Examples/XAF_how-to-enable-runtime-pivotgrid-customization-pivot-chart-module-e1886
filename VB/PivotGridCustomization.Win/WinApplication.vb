...
Namespace PivotGridCustomization.Win
	Partial Public Class PivotGridCustomizationWindowsFormsApplication
		...
		Private Sub PivotGridCustomizationWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
			e.Updater.Update()
			e.Handled = True
#Else
